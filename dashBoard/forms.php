...
<div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
    <main class="w-full flex-grow p-6">
        <h1 class="w-full text-3xl text-black pb-6">Vos formulaires</h1>
        ...
        <div class="flex flex-wrap">
            ...
            <div class="leading-loose">
                <form class="p-10 bg-white rounded shadow-xl" method="POST" action="../Fonctionnalty/gallerySend.php" enctype="multipart/form-data">
                    <p class="text-xl pb-6 flex items-center">
                        <i class="fas fa-list mr-3"></i> Ajouter une image à la gallery
                    </p>
                    <div class="">
                        <label class="block text-sm text-gray-600" for="titre">Donner un titre a votre image</label>
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="title" name="title" type="text" placeholder="Titre" aria-label="Name">
                    </div>
                    <div class="">
                        <label class="block text-sm text-gray-600" for="img">Sélectionner une image pour votre gallery </label>
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="img" name="photo" type="file">
                    </div>

                    <div class="mt-6">
                        <button class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" name="submitPhoto" type="submit">Ajouter</button>
                    </div>
                </form>
            </div>

            <div class="leading-loose">
                <form class="p-10 bg-white rounded shadow-xl" action="../Fonctionnalty/partenarAction.php" method="POST" enctype="multipart/form-data">
                    <p class="text-xl pb-6 flex items-center">
                        <i class="fas fa-list mr-3"></i> Ajouter le logo de vos partenaires
                    </p>
                    <div class="">
                        <label class="block text-sm text-gray-600" for="titre">Donner un titre au logo</label>
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="title" name="title" type="text" placeholder="Titre" aria-label="Name">
                    </div>
                    <div class="">
                        <label class="block text-sm text-gray-600" for="logo">Sélectionner une image pour votre gallery </label>
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="logo" name="photo" type="file">
                    </div>

                    <div class="mt-6">
                        <button class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" name="submitlogo" type="submit">Ajouter</button>
                    </div>
                </form>
            </div>
            </div>
